...
#if defined(CONFIG_MACH_MSM7X27_PECAN) // pecan
  // PLL
...
tuning_reg_settings_array[] = {
  ...
  {0x0990, 0x0005, WORD_LEN},	//      = 5
  {0x098E, 0x481A, WORD_LEN},	//fd_period_50Hz (A)
  {0x0990, 0x00BA, WORD_LEN},	//      = 184
  {0x098E, 0x481C, WORD_LEN},	//fd_period_60Hz (A)
  {0x0990, 0x009C, WORD_LEN},	//      = 156
  {0x098E, 0xC81E, WORD_LEN},	//fd_search_f1_50hz (A)
  {0x0990, 0x001E, WORD_LEN},	//      = 22
  {0x098E, 0xC81F, WORD_LEN},	//fd_search_f2_50hz (A)
  {0x0990, 0x0034, WORD_LEN},	//      = 33
  {0x098E, 0xC820, WORD_LEN},	//fd_search_f1_60hz (A)
  {0x0990, 0x0022, WORD_LEN},	//      = 34
  {0x098E, 0xC821, WORD_LEN},	//fd_search_f2_60hz (A)
  ...
  {0x0990, 0x0080, WORD_LEN}, 	// MCU_DATA_0
  {0x098E, 0xE826, WORD_LEN}, 	// MCU_ADDRESS [PRI_A_CONFIG_AE_TRACK_BASE_TARGET]
  {0x0990, 0x0039, WORD_LEN}, 	//003C MCU_DATA_0
  {0x098E, 0x6829, WORD_LEN}, 	// MCU_ADDRESS [PRI_A_CONFIG_AE_TRACK_AE_MIN_VIRT_DGAIN]
  {0x0990, 0x0080, WORD_LEN}, 	// MCU_DATA_0
  {0x098E, 0x682B, WORD_LEN}, 	// MCU_ADDRESS [PRI_A_CONFIG_AE_TRACK_AE_MAX_VIRT_DGAIN]
  {0x0990, 0x0080, WORD_LEN}, 	// MCU_DATA_0
  {0x098E, 0x682D, WORD_LEN}, 	// MCU_ADDRESS [PRI_A_CONFIG_AE_TRACK_AE_MIN_VIRT_AGAIN]
  {0x0990, 0x0028, WORD_LEN}, 	// MCU_DATA_0
  {0x098E, 0x4867, WORD_LEN},
  {0x0990, 0x0028, WORD_LEN},
  {0x098E, 0x4871, WORD_LEN},  	// MCU_ADDRESS [CAM1_CTL_MIN_ANALOG_GAIN]
  {0x0990, 0x0028, WORD_LEN}, 	//0x0039 	// MCU_DATA_0
  {0x098E, 0x682F, WORD_LEN}, 	// MCU_ADDRESS [PRI_A_CONFIG_AE_TRACK_AE_MAX_VIRT_AGAIN]
  {0x0990, 0x0120, WORD_LEN},		//1F8 	// MCU_DATA_0
  {0x098E, 0x6815, WORD_LEN}, 	// MCU_ADDRESS [PRI_A_CONFIG_FD_MAX_FDZONE_50HZ]
  {0x0990, 0x000A, WORD_LEN}, 	// MCU_DATA_0
  ...
  {0x098E, 0x4436, WORD_LEN}, 	// MCU_ADDRESS [awb_sharpness_th]
  {0x0990, 0x01F4, WORD_LEN}, 	// MCU_DATA_0
  {0x098E, 0x4873, WORD_LEN}, 	// 4873 //MCU_ADDRESS [CAM1_AWB_CCM_L_0]
  {0x0990, 0x01C4, WORD_LEN}, 	// 01E1 //MCU_DATA_0
  {0x098E, 0x4875, WORD_LEN}, 	// 4875 //MCU_ADDRESS [CAM1_AWB_CCM_L_1]
  {0x0990, 0xFEFD, WORD_LEN}, 	// FEFA //MCU_DATA_0
  {0x098E, 0x4877, WORD_LEN}, 	// 4877 //MCU_ADDRESS [CAM1_AWB_CCM_L_2]
  {0x0990, 0x003E, WORD_LEN}, 	// 0024 //MCU_DATA_0
  {0x098E, 0x4879, WORD_LEN}, 	// 4879 //MCU_ADDRESS [CAM1_AWB_CCM_L_3]
  {0x0990, 0xFF91, WORD_LEN}, 	// FFD0 //MCU_DATA_0
  {0x098E, 0x487B, WORD_LEN}, 	// 487B //MCU_ADDRESS [CAM1_AWB_CCM_L_4]
  {0x0990, 0x0192, WORD_LEN}, 	// 0136 //MCU_DATA_0
  {0x098E, 0x487D, WORD_LEN}, 	// 487D //MCU_ADDRESS [CAM1_AWB_CCM_L_5]
  {0x0990, 0xFFDA, WORD_LEN}, 	// FFF7 //MCU_DATA_0
  {0x098E, 0x487F, WORD_LEN}, 	// 487F //MCU_ADDRESS [CAM1_AWB_CCM_L_6]
  {0x0990, 0xFFED, WORD_LEN}, 	// FFD7 //MCU_DATA_0
  {0x098E, 0x4881, WORD_LEN}, 	// 4881 //MCU_ADDRESS [CAM1_AWB_CCM_L_7]
  {0x0990, 0xFFD2, WORD_LEN}, 	// FF56 //MCU_DATA_0
  {0x098E, 0x4883, WORD_LEN}, 	// 4883 //MCU_ADDRESS [CAM1_AWB_CCM_L_8]
  {0x0990, 0x013F, WORD_LEN}, 	// 01D1 //MCU_DATA_0
  {0x098E, 0x4885, WORD_LEN},  	// 4885 //MCU_ADDRESS [CAM1_AWB_CCM_L_9]
  {0x0990, 0x0022, WORD_LEN},  	// 0022 //MCU_DATA_0
  {0x098E, 0x4887, WORD_LEN},  	// 4887 //MCU_ADDRESS [CAM1_AWB_CCM_L_10]
  {0x0990, 0x004E, WORD_LEN},  	// 005F //MCU_DATA_0
  {0x098E, 0x4889, WORD_LEN},  	// 4889 //MCU_ADDRESS [CAM1_AWB_CCM_RL_0]
  {0x0990, 0xFF86, WORD_LEN},  	// 001A //MCU_DATA_0
  {0x098E, 0x488B, WORD_LEN},  	// 488B //MCU_ADDRESS [CAM1_AWB_CCM_RL_1]
  {0x0990, 0x00E8, WORD_LEN},  	// 005B //MCU_DATA_0
  {0x098E, 0x488D, WORD_LEN},  	// 488D //MCU_ADDRESS [CAM1_AWB_CCM_RL_2]
  {0x0990, 0xFF91, WORD_LEN},  	// FF8A //MCU_DATA_0
  {0x098E, 0x488F, WORD_LEN},  	// 488F //MCU_ADDRESS [CAM1_AWB_CCM_RL_3]
  {0x0990, 0x002D, WORD_LEN},  	// FFF2 //MCU_DATA_0
  {0x098E, 0x4891, WORD_LEN},  	// 4891 //MCU_ADDRESS [CAM1_AWB_CCM_RL_4]
  {0x0990, 0xFFC3, WORD_LEN},  	// 0022 //MCU_DATA_0
  {0x098E, 0x4893, WORD_LEN},  	// 4893 //MCU_ADDRESS [CAM1_AWB_CCM_RL_5]
  {0x0990, 0x0012, WORD_LEN},  	// FFEA //MCU_DATA_0
  {0x098E, 0x4895, WORD_LEN},  	// 4895 //MCU_ADDRESS [CAM1_AWB_CCM_RL_6]
  {0x0990, 0x0011, WORD_LEN},  	// 0021 //MCU_DATA_0
  {0x098E, 0x4897, WORD_LEN},  	// 4897 //MCU_ADDRESS [CAM1_AWB_CCM_RL_7]
  {0x0990, 0xFFCA, WORD_LEN},  	// 0037 //MCU_DATA_0
  {0x098E, 0x4899, WORD_LEN},  	// 4899 //MCU_ADDRESS [CAM1_AWB_CCM_RL_8]
  {0x0990, 0x0026, WORD_LEN},  	// FFA7 //MCU_DATA_0
  {0x098E, 0x489B, WORD_LEN},  	// 489B //MCU_ADDRESS [CAM1_AWB_CCM_RL_9]
  {0x0990, 0x0016, WORD_LEN},  	// 0016 //MCU_DATA_0
  {0x098E, 0x489D, WORD_LEN},  	// 489D //MCU_ADDRESS [CAM1_AWB_CCM_RL_10]
  {0x0990, 0xFFE1, WORD_LEN},  	// FFC8 //MCU_DATA_0
  {0x098E, 0x489F, WORD_LEN}, 	// 489F //MCU_ADDRESS [CAM1_AWB_LL_CCM_0]
  {0x0990, 0x0100, WORD_LEN}, 	// 0100 //MCU_DATA_0
  {0x098E, 0x48A1, WORD_LEN}, 	// 48A1 //MCU_ADDRESS [CAM1_AWB_LL_CCM_1]
  {0x0990, 0x0000, WORD_LEN}, 	// 0000 //MCU_DATA_0
  {0x098E, 0x48A3, WORD_LEN}, 	// 48A3 //MCU_ADDRESS [CAM1_AWB_LL_CCM_2]
  {0x0990, 0x0000, WORD_LEN}, 	// 0000 //MCU_DATA_0
  {0x098E, 0x48A5, WORD_LEN}, 	// 48A5 //MCU_ADDRESS [CAM1_AWB_LL_CCM_3]
  {0x0990, 0x0000, WORD_LEN}, 	// 0000 //MCU_DATA_0
  {0x098E, 0x48A7, WORD_LEN}, 	// 48A7 //MCU_ADDRESS [CAM1_AWB_LL_CCM_4]
  {0x0990, 0x0100, WORD_LEN}, 	// 0100 //MCU_DATA_0
  {0x098E, 0x48A9, WORD_LEN}, 	// 48A9 //MCU_ADDRESS [CAM1_AWB_LL_CCM_5]
  {0x0990, 0x0000, WORD_LEN}, 	// 0000 //MCU_DATA_0
  {0x098E, 0x48AB, WORD_LEN}, 	// 48AB //MCU_ADDRESS [CAM1_AWB_LL_CCM_6]
  {0x0990, 0x0000, WORD_LEN}, 	// 0000 //MCU_DATA_0
  {0x098E, 0x48AD, WORD_LEN}, 	// 48AD //MCU_ADDRESS [CAM1_AWB_LL_CCM_7]
  {0x0990, 0x0000, WORD_LEN}, 	// 0000 //MCU_DATA_0
  {0x098E, 0x48AF, WORD_LEN}, 	// 48AF //MCU_ADDRESS [CAM1_AWB_LL_CCM_8]
  {0x0990, 0x0100, WORD_LEN}, 	// 0100 //MCU_DATA_0
  //AWB
  {0x098E, 0x4887, WORD_LEN},  	// MCU_ADDRESS
  {0x0990, 0x004E, WORD_LEN},  	// MCU_DATA_0
  ...
  {0x0990, 0xFFE1, WORD_LEN},  	// MCU_DATA_0
  {0x098E, 0x48B8, WORD_LEN}, 	// MCU_ADDRESS [CAM1_AWB_X_SHIFT]
  {0x0990, 0x0020, WORD_LEN}, 	// 0028	//MCU_DATA_0
  {0x098E, 0x48BA, WORD_LEN}, 	// MCU_ADDRESS [CAM1_AWB_Y_SHIFT]
  {0x0990, 0x000C, WORD_LEN}, 	// 0011	//MCU_DATA_0
  {0x098E, 0x48BC, WORD_LEN}, 	// MCU_ADDRESS [CAM1_AWB_RECIP_XSCALE]
  {0x0990, 0x0060, WORD_LEN}, 	// MCU_DATA_0
  {0x098E, 0x48BE, WORD_LEN}, 	// MCU_ADDRESS [CAM1_AWB_RECIP_YSCALE]
  {0x0990, 0x00AB, WORD_LEN}, 	// MCU_DATA_0
  {0x098E, 0x48C0, WORD_LEN}, 	// MCU_ADDRESS [CAM1_AWB_ROT_CENTER_X]
  {0x0990, 0x03F0, WORD_LEN}, 	// 0x3FC MCU_DATA_0
  {0x098E, 0x48C2, WORD_LEN}, 	// MCU_ADDRESS [CAM1_AWB_ROT_CENTER_Y]
  {0x0990, 0x03E7, WORD_LEN}, 	// MCU_DATA_0
  {0x098E, 0xC8C4, WORD_LEN}, 	// MCU_ADDRESS [CAM1_AWB_ROT_SIN]
  {0x0990, 0x0034, WORD_LEN}, 	// MCU_DATA_0
  ...
  {0x3EFE, 0x130D, WORD_LEN}, 	// RESERVED_CORE_3EFE
  //[Low_Power_Mode]
  {0x3170, 0x000A, WORD_LEN},    //Dynamic pwr setting
  {0x3174, 0x8060, WORD_LEN},      //Dynamic pwr setting
  ...
  {0x098E, 0x4858, WORD_LEN},       //LP Mode (B)
  {0x0990, 0x22B0, WORD_LEN},       //
  {0x317A, 0x000A, WORD_LEN}, 	//
  {0x098E, 0x4822, WORD_LEN}, 	//
  {0x0990, 0x000A, WORD_LEN}, 	//
  {0x098E, 0x4824, WORD_LEN}, 	//
  {0x0990, 0x000A, WORD_LEN}, 	//
  {0x098E, 0x484F, WORD_LEN}, 	//
  {0x0990, 0x000A, WORD_LEN}, 	//
  {0x098E, 0x4851, WORD_LEN}, 	//
  {0x0990, 0x000A, WORD_LEN}, 	//
  //[Lens Correction 85% 2010/10/26 23:05:06_152]
  {0x3640, 0x0250, WORD_LEN},  	//  P_G1_P0Q0
  {0x3642, 0x5B2E, WORD_LEN},  	//  P_G1_P0Q1
  {0x3644, 0x6191, WORD_LEN},  	//  P_G1_P0Q2
  {0x3646, 0xBCCE, WORD_LEN},  	//  P_G1_P0Q3
  {0x3648, 0xDDB1, WORD_LEN},  	//  P_G1_P0Q4
  {0x364A, 0x0270, WORD_LEN},  	//  P_R_P0Q0
  {0x364C, 0xAA6E, WORD_LEN}, 	//800E //AA6E 	//  P_R_P0Q1
  {0x364E, 0x1FD1, WORD_LEN}, 	//28D1 //2ED1 	//  P_R_P0Q2
  {0x3650, 0x1B70, WORD_LEN},  	//  P_R_P0Q3
  {0x3652, 0xE670, WORD_LEN},  	//  P_R_P0Q4
  {0x3654, 0x0330, WORD_LEN},  	//  P_B_P0Q0
  {0x3656, 0x022F, WORD_LEN},  	//  P_B_P0Q1
  {0x3658, 0x1E71, WORD_LEN},  	//  P_B_P0Q2
  {0x365A, 0xCFAF, WORD_LEN},  	//  P_B_P0Q3
  {0x365C, 0xB930, WORD_LEN},  	//  P_B_P0Q4
  {0x365E, 0x0290, WORD_LEN},  	//  P_G2_P0Q0
  {0x3660, 0xCA8E, WORD_LEN},  	//  P_G2_P0Q1
  {0x3662, 0x7971, WORD_LEN},  	//  P_G2_P0Q2
  {0x3664, 0x294F, WORD_LEN},  	//  P_G2_P0Q3
  {0x3666, 0x9012, WORD_LEN},  	//  P_G2_P0Q4
  {0x3680, 0xA78D, WORD_LEN},  	//  P_G1_P1Q0
  {0x3682, 0xB12F, WORD_LEN},  	//  P_G1_P1Q1
  {0x3684, 0xB3D0, WORD_LEN},  	//  P_G1_P1Q2
  {0x3686, 0x1DB0, WORD_LEN},  	//  P_G1_P1Q3
  {0x3688, 0x0F12, WORD_LEN},  	//  P_G1_P1Q4
  {0x368A, 0x966D, WORD_LEN},  	//  P_R_P1Q0
  {0x368C, 0x204E, WORD_LEN},  	//  P_R_P1Q1
  {0x368E, 0xE80D, WORD_LEN},  	//  P_R_P1Q2
  {0x3690, 0x8DF0, WORD_LEN},  	//  P_R_P1Q3
  {0x3692, 0x15B0, WORD_LEN},  	//  P_R_P1Q4
  {0x3694, 0x0B2E, WORD_LEN},  	//  P_B_P1Q0
  {0x3696, 0x77EE, WORD_LEN},  	//  P_B_P1Q1
  {0x3698, 0x092F, WORD_LEN},  	//  P_B_P1Q2
  {0x369A, 0x9490, WORD_LEN},  	//  P_B_P1Q3
  {0x369C, 0xA210, WORD_LEN},  	//  P_B_P1Q4
  {0x369E, 0x34AD, WORD_LEN},  	//  P_G2_P1Q0
  {0x36A0, 0xB62F, WORD_LEN},  	//  P_G2_P1Q1
  {0x36A2, 0x4350, WORD_LEN},  	//  P_G2_P1Q2
  {0x36A4, 0x2490, WORD_LEN},  	//  P_G2_P1Q3
  {0x36A6, 0x8812, WORD_LEN},  	//  P_G2_P1Q4
  {0x36C0, 0x7E11, WORD_LEN},  	//  P_G1_P2Q0
  {0x36C2, 0x3050, WORD_LEN},  	//  P_G1_P2Q1
  {0x36C4, 0xB093, WORD_LEN},  	//  P_G1_P2Q2
  {0x36C6, 0xCB90, WORD_LEN},  	//  P_G1_P2Q3
  {0x36C8, 0x02D5, WORD_LEN},  	//  P_G1_P2Q4
  {0x36CA, 0x02D2, WORD_LEN}, 	//12D2 	//  P_R_P2Q0
  {0x36CC, 0x8950, WORD_LEN},  	//  P_R_P2Q1
  {0x36CE, 0xE5F2, WORD_LEN},  	//  P_R_P2Q2
  {0x36D0, 0x7C90, WORD_LEN},  	//  P_R_P2Q3
  {0x36D2, 0x7D93, WORD_LEN},  	//  P_R_P2Q4
  {0x36D4, 0x1312, WORD_LEN},  	//  P_B_P2Q0
  {0x36D6, 0x3AF0, WORD_LEN},  	//  P_B_P2Q1
  {0x36D8, 0x9274, WORD_LEN},  	//  P_B_P2Q2
  {0x36DA, 0xD8AF, WORD_LEN},  	//  P_B_P2Q3
  {0x36DC, 0x7815, WORD_LEN},  	//  P_B_P2Q4
  {0x36DE, 0x6CB1, WORD_LEN},  	//  P_G2_P2Q0
  {0x36E0, 0xDDEF, WORD_LEN},  	//  P_G2_P2Q1
  {0x36E2, 0xC213, WORD_LEN},  	//  P_G2_P2Q2
  {0x36E4, 0x07AE, WORD_LEN},  	//  P_G2_P2Q3
  {0x36E6, 0x2335, WORD_LEN},  	//  P_G2_P2Q4
  {0x3700, 0x144E, WORD_LEN},  	//  P_G1_P3Q0
  {0x3702, 0x0C90, WORD_LEN},  	//  P_G1_P3Q1
  {0x3704, 0x6DF1, WORD_LEN},  	//  P_G1_P3Q2
  {0x3706, 0x8931, WORD_LEN},  	//  P_G1_P3Q3
  {0x3708, 0xE593, WORD_LEN},  	//  P_G1_P3Q4
  {0x370A, 0x4C8F, WORD_LEN},  	//  P_R_P3Q0
  {0x370C, 0xFAEC, WORD_LEN},  	//  P_R_P3Q1
  {0x370E, 0xE30D, WORD_LEN},  	//  P_R_P3Q2
  {0x3710, 0x6990, WORD_LEN},  	//  P_R_P3Q3
  {0x3712, 0xC2F3, WORD_LEN},  	//  P_R_P3Q4
  {0x3714, 0x98AF, WORD_LEN},  	//  P_B_P3Q0
  {0x3716, 0x80ED, WORD_LEN},  	//  P_B_P3Q1
  {0x3718, 0x2B31, WORD_LEN},  	//  P_B_P3Q2
  {0x371A, 0xBC2E, WORD_LEN},  	//  P_B_P3Q3
  {0x371C, 0xA354, WORD_LEN},  	//  P_B_P3Q4
  {0x371E, 0x724B, WORD_LEN},  	//  P_G2_P3Q0
  {0x3720, 0x1890, WORD_LEN},  	//  P_G2_P3Q1
  {0x3722, 0x9492, WORD_LEN},  	//  P_G2_P3Q2
  {0x3724, 0xA6B1, WORD_LEN},  	//  P_G2_P3Q3
  {0x3726, 0x11D2, WORD_LEN},  	//  P_G2_P3Q4
  {0x3740, 0x8673, WORD_LEN},  	//  P_G1_P4Q0
  {0x3742, 0xA292, WORD_LEN},  	//  P_G1_P4Q1
  {0x3744, 0x5DF5, WORD_LEN},  	//  P_G1_P4Q2
  {0x3746, 0x02F1, WORD_LEN},  	//  P_G1_P4Q3
  {0x3748, 0xFD77, WORD_LEN},  	//  P_G1_P4Q4
  {0x374A, 0x94B3, WORD_LEN},  	//  P_R_P4Q0
  {0x374C, 0x2AB2, WORD_LEN},  	//  P_R_P4Q1
  {0x374E, 0x0715, WORD_LEN},  	//  P_R_P4Q2
  {0x3750, 0xCF34, WORD_LEN},  	//  P_R_P4Q3
  {0x3752, 0xC256, WORD_LEN},  	//  P_R_P4Q4
  {0x3754, 0xCDF3, WORD_LEN},  	//  P_B_P4Q0
  {0x3756, 0x84D3, WORD_LEN},  	//  P_B_P4Q1
  {0x3758, 0x3EF6, WORD_LEN},  	//  P_B_P4Q2
  {0x375A, 0x55D4, WORD_LEN},  	//  P_B_P4Q3
  {0x375C, 0xA438, WORD_LEN},  	//  P_B_P4Q4
  {0x375E, 0xE2D2, WORD_LEN},  	//  P_G2_P4Q0
  {0x3760, 0x0392, WORD_LEN},  	//  P_G2_P4Q1
  {0x3762, 0x56F5, WORD_LEN},  	//  P_G2_P4Q2
  {0x3764, 0x0F90, WORD_LEN},  	//  P_G2_P4Q3
  {0x3766, 0x82B8, WORD_LEN},  	//  P_G2_P4Q4
  {0x3784, 0x0438, WORD_LEN}, 	// CENTER_COLUMN
  ...
  {0x098E, 0xE876, WORD_LEN}, 	// MCU_ADDRESS [PRI_A_CONFIG_LL_END_SATURATION]
  {0x0990, 0x0060, WORD_LEN}, 	// MCU_DATA_0
  {0x098E, 0xE877, WORD_LEN},  	// MCU_ADDRESS [PRI_A_CONFIG_LL_END_SATURATION]
...
wb_mode_incandescent_reg_settings_array[] = {
  ...
  //polling
  {0x098E, 0xAC3B, WORD_LEN}, 	// MCU_ADDRESS [AWB_R_RATIO_PRE_AWB]
  {0x0990, 0x0057, WORD_LEN}, 	//0058	//MCU_DATA_0
  {0x098E, 0xAC3C, WORD_LEN}, 	// MCU_ADDRESS [AWB_B_RATIO_PRE_AWB]
  {0x0990, 0x0028, WORD_LEN}, 	//002D	// MCU_DATA_0
#endif
};
...
wb_mode_fluorescent_reg_settings_array[] = {
  ...
  {0xdddd, 0xdddd, WORD_LEN},
  {0x098E, 0xAC3B, WORD_LEN}, 	// MCU_ADDRESS [AWB_R_RATIO_PRE_AWB]
  {0x0990, 0x0050, WORD_LEN}, 	//0048	//4C 	// MCU_DATA_0
  {0x098E, 0xAC3C, WORD_LEN}, 	// MCU_ADDRESS [AWB_B_RATIO_PRE_AWB]
  {0x0990, 0x002E, WORD_LEN}, 	//0032	//30 	// MCU_DATA_0
#endif
};
...
wb_mode_daylight_reg_settings_array[] = {
  ...
  //polling
  {0x098E, 0xAC3B, WORD_LEN}, 	// MCU_ADDRESS [AWB_R_RATIO_PRE_AWB]
  {0x0990, 0x0042, WORD_LEN}, 	// MCU_DATA_0
  {0x098E, 0xAC3C, WORD_LEN}, 	// MCU_ADDRESS [AWB_B_RATIO_PRE_AWB]
  {0x0990, 0x0040, WORD_LEN}, 	// MCU_DATA_0
#endif
};
