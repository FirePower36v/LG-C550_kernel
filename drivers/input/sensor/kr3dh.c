...
#define KR3DH_FLIP_DOWN_MASK 0x50
#define KR3DH_FLIP_UP_MASK 0x60
#else
#define KR3DH_FLIP_DOWN_MASK 0x60
#define KR3DH_FLIP_UP_MASK 0x50
#endif
...
static void flip_work_func(struct work_struct *work_ptr)
{
	...
	} else if (buf == KR3DH_FLIP_DOWN_MASK) {
